        ...
        <div class="container">
            <div class="row">
          	    <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        <div class="sidebar__item">
                            <h4> 마이페이지</h4>
                            <ul>            
                                <li><a href="Product-Des.jsp">회원정보 수정&탈퇴</a></li>
                                <li><a href="Product-Des copy.jsp">이벤트 참여 내역</a></li>
                                <li><a href="Product-Des copy.jsp">만족도조사 내역</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
   			 ...
   			 <!-- <div id="join_form">로그인 폼 -->
    						<form>
        					<h5 class="join" style="letter-spacing:-1px;">회원정보 수정</h5>
        ...
        <!-- <span>PW</span> -->
            ...
            <!-- <span>PW</span> -->
        				...
        				<p>
							...
							<hr>
    <p class="find">
        <span><a href="Main-page.jsp" >로그인 페이지로 이동</a></span>
    </p>
    </div>
    <div>
        </div>
                        ...
                        <div class="Withdrawal">
                 			 <button type="submit" class="site-btn">회원탈퇴</button>
                        </div>
                    </div>
                </div>
<!--                 </div>
