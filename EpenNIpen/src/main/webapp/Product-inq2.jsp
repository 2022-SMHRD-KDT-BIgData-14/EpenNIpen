	...
	<section class="product spad">
					...
					<div class="product__discount">
						...
						<div class="row">
							<div class="select-filter">
								...
								<br> 필터입력값 : <input type="text" id="showFilter" /> <input
		...
		function makeFormat(res){
			...
			for(var i=0; i<res.length; i++){
				...
				$("#allshowFilter").last().append("<img src="+ res[i].img +" width='225'><br>");
				$("#allshowFilter").last().append(res[i].price + "<br>");
				
 		        $("#allshowFilter").last().append("<a href='" + res[i].description_1 + "'>"   + res[i].product + "</a><br>");
				//$("#nameshowFilter").append(res[i].product + "<br>");
				//$("#priceshowFilter").append(res[i].price + "<br>");
			}
...
/* 		function img_info(img){
			for(var i; i<img.length; i++){
				$('#img1').append("<img src="+ res[i].img +">");
							...
							<h3>필터된 상품 목록 보여주기</h3>
								<div class="poduct_list">
									<div id="allshowFilter" class="product"> 
										<div id="nameshowFilter" class="product-name"></div>
										<div id="priceshowFilter" class="product-price"></div>
									</div>
								</div>
                    ...
                    <div class="filterItem">
                    	<img id= "img1" src="">
                    		<script> document.getElementByid('img1').src=img_info()</script>
                    	<ul>
                    		<li><a href="#"><i class="fa fa-heart"></i></a></li>
                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>           	                    		
